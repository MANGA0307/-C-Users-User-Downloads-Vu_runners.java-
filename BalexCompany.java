...
public class BalexCompany {
    ...
    public static void calculatePay(double basePay, int hoursWorked) {
        ...
        // Check if base pay is less than minimum wage code will print error
        if (basePay < MIN_WAGE) {
            System.out.println("Error: Base pay must be at least $" + MIN_WAGE + " per hour.");
            return;
        }

        // Check if hours worked is greater than the maximum allowed hours and if greater code will print error
